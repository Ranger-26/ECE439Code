...
class SensorsToMotor(Node): 
    def __init__(self): 
        ...
        self.subscriber_A0_proc = self.create_subscription(Int32, 'sensors_A0_proc', self.cal_and_pub_A0, 1) 
    ...
    def cal_and_pub_A0(self, msg_in): 
        ...
        # Publish the newly packed Message
            self.publisher_motor_left.publish(-0.1)
            self.publisher_motor_right.publish(-0.1)
